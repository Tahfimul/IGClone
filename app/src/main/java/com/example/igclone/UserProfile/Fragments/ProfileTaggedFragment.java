...
public class ProfileTaggedFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        message.setText("You are viewing tagged thumbnails");
    ...
    private void setUpThumbnailRecycler() {
        UserProfileNavUtil.initTaggedRecycler(thumbnailRecycler, getContext());
    }
